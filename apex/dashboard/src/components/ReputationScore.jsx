...
const ReputationScore = ({ 
  ...
  useEffect(() => {
    if (history.length === 0) {
      ...
      const mockHistory = [];
      const today = new Date();
      const baseScore = 91; // Start at 91, end at 95
      ...
      for (let i = 6; i >= 0; i--) {
        ...
        let score = baseScore + (6 - i) * 0.67; // Gradual improvement from 91 to 95
    ...
    <div style={{
      ...
      <div style={{ 
        ...
        <div style={{ marginTop: '1rem' }}>
          <button
            onClick={() => openEtherscan('address', agentId)}
            style={{
        ...
        <div style={{ marginTop: '0.5rem' }}>
          <button
            onClick={() => openEtherscan('token', nftTokenId)}
            style={{
