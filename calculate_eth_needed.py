...
def main():
    try:
        ...
        print("SEPOLIA ETH CALCULATOR FOR CONTINUOUS TRADING")
        print("=" * 60)
        ...
        for multiplier in multipliers:
            ...
            eth_per_trade = identity.w3.from_wei(gas_price_multiplier * gas_per_trade, 'ether')
        ...
        for scenario in scenarios:
            eth_needed_1x = identity.w3.from_wei(gas_price * gas_per_trade * scenario['trades'], 'ether')
            eth_needed_1_5x = identity.w3.from_wei(gas_price * 1.5 * gas_per_trade * scenario['trades'], 'ether')
            eth_needed_2x = identity.w3.from_wei(gas_price * 2.0 * gas_per_trade * scenario['trades'], 'ether')
        ...
        print(f"\n📈 CURRENT CAPACITY ANALYSIS:")
        eth_per_trade_1_5x = identity.w3.from_wei(gas_price * 1.5 * gas_per_trade, 'ether')
